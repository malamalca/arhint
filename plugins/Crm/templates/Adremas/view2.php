<?php
    ...
    $label_select = [
        ...
        'form' => [
            ...
            'lines' => [
                ...
                'fs_adrema_legend' => sprintf('<h2>%s</h2>', __d('crm', 'Addresses')),
                'fs_adrema_start' => '<fieldset>',
                'fs_adrema_table' => ['table' => [
                    'head' => [
                        'rows' => [0 => ['columns' => [
                            'cb' => '&nbsp;',
                        ]]],
                ...
                'fs_table_header' => '<table cellpadding="0" cellspacing="0" id="crm-adrema">' .
                    '<thead><tr>' .
                    sprintf('<th class="td-adrema-link"><button id="SelectAll">&#10003;</button></th>') .
    ...
    foreach ($addresses as $k => $address) {
        ...
        $adr['adr' . $k . '_2'] = sprintf(
            '<td class="td-adrema-link"><input type="checkbox" name="address" value="%s" class="browser-default" /></td>',
            $address->id
        );

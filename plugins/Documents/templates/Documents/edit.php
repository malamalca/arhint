...
$documentEdit = [
    ...
    'form' => [
        ...
        'lines' => [
            ...
            'fs_dates_table_start' => '<table id="document-dates-table"><tr><td>',
            'dat_issue' => [
                'method' => 'control',
                'parameters' => [
                    'dat_issue',
...
if ($document->isInvoice()) {
    ...
    // analytics and taxes
    $analytics = [];
    if ($document->isInvoice() && $counter->kind == 'received') {
    ...
    $paymentDetails = [
        ...
        'fs_payment_table_start' => '<table id="DocumentPayment"><tr><td>',
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $("#document-tax-table").DocumentTaxEditor({
            vats: vatLevels
        });
        $("#document-items-table").DocumentItemEditor({
            vats: vatLevels,
            itemsAutocompleteUrl: itemsAutocompleteUrl
        });

        $("#document-edit-form").DocumentEditClient({
            mode: "<?= $counter->kind;?>",
        ...
        $("#document-dat-issue").change(function(dateText, inst) {
            ...
            if ($('#document-dat-service').val() == "") $('#document-dat-service').val(dateVal);
            if ($('#document-dat-expire').val() == "") $('#document-dat-expire').val(dueDate);
        });
        ...
        $("#MenuEditPreview").click(function(e) {
            ...
            var defaultAction = $("#document-edit-form").prop("action");
            var defaultTarger = $("#document-edit-form").prop("target");
        ...
        tinymce.init({
            selector:'textarea#document-descript',
            menubar:false,
            statusbar: false,

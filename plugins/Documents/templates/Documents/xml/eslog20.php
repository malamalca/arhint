...
foreach ((array)$documents as $document) {
    $transformed['Document']['M_INVOIC'][$i] = [
        ...
        'S_BGM' => [
            ...
            'C_C106' => [
                'D_1004' => h($document->no),
            ],
        ],
        'S_DTM' => [
            0 => [
                'C_C507' => [
                    'D_2005' => '137', // document date-time
                    'D_2380' => (string)$document->dat_issue->toDateString(),
                ],
            ],
            1 => [
                'C_C507' => [
                    'D_2005' => '35', // delivery date-time
                    'D_2380' => (string)$document->dat_service->toDateString(),
                ],
            ],
        ],
        'S_FTX' => [
        ...
        'G_SG1' => [
            'S_RFF' => [
                'C_C506' => [
                    'D_1153' => 'PQ',
                    'D_1154' => $document->pmt_type . $document->pmt_module . $document->pmt_ref,
                ],
            ],
        ],
        ...
        'G_SG2' => [
            0 => [
                ...
                'S_NAD' => [
                    'D_3035' => 'BY',
                    'C_C080' => [
                        'D_3036' => $document->buyer->title,
                    ],
                    'C_C059' => [
                        'D_3042' => $document->buyer->street,
                    ],
                    'D_3164' => $document->buyer->city,
                    'C_C819' => null,
                    'D_3251' => $document->buyer->zip,
                    'D_3207' => $document->buyer->country_code ?? 'SI',
                ],
                'G_SG3' => [
                    /*0 => ['S_RFF' => [
                        'C_C506' => [
            ...
            1 => [
                'S_NAD' => [
                    'D_3035' => 'SE',
                    'C_C080' => [
                        'D_3036' => $document->issuer->title,
                    ],
                    'C_C059' => [
                        'D_3042' => $document->issuer->street,
                    ],
                    'D_3164' => $document->issuer->city,
                    'C_C819' => null,
                    'D_3251' => $document->issuer->zip,
                    'D_3207' => $document->issuer->country_code ?? 'SI',
                ],
                'S_FII' => [
                    'D_3035' => 'RB',
                    'C_C078' => [
                        'D_3194' => $document->issuer->iban,
                    ],
                    'C_C088' => [
                        'D_3433' => str_pad($document->issuer->bic, 11, 'X'),
                    ],
                ],
                'G_SG3' => [
                    /*0 => ['S_RFF' => [
                        'C_C506' => [
                            'D_1153' => '0199',
                            'D_1154' => $document->issuer->tax_no,
                        ],
                    ]],
                    1 => ['S_RFF' => [
                        'C_C506' => [
                            'D_1153' => 'GN',
                            'D_1154' => $document->issuer->mat_no,
                        ],
                    ]],*/
                    2 => ['S_RFF' => [
                        'C_C506' => [
        ...
        'G_SG8' => [
            ...
            'S_DTM' => [
                'C_C507' => [
                    'D_2005' => '13',
                    'D_2380' => $document->dat_expire->toDateString(),
                ],
            ],
            'S_PAI' => [
                'C_C534' => [

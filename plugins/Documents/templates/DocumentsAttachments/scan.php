...
$attachmentScan = [
    'title_for_layout' => __d('documents', 'Scan an Attachment'),
    'form' => [
        'defaultHelper' => $this->Form,
        'pre' => '<div class="form"><div id="spinner" style="text-align: center;">' .
            $this->Html->image('Documents.loading.gif') . '</div>',
        'post' => '</div>',
        'lines' => [
            'form_start' => [
                'method' => 'create',
...
echo $this->Lil->form($attachmentScan, 'Documents.DocumentsAttachments.scan');
?>

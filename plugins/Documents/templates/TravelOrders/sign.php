...
$pageData = [
    'title_for_layout' => __d('documents', 'Sign Travel Order #{0}', h($document->no)),
    'menu' => [
        'back' => [
            ...
            'form' => [
                ...
                'lines' => [
                    'form_start' => [
                        ...
                        'parameters' => [
                            $document,
                            ['url' => ['action' => 'sign', $document->id]],
                        ],
                    ],
                    'submit' => [
                        'method' => 'button',
                        'parameters' => [
                            __d('documents', 'Sign & Submit for Approval'),
...
echo $this->Lil->panels($pageData, 'Documents.TravelOrders.sign');

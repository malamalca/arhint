jQuery.fn.InvoiceItemEditor = function (pOptions) {
    ...
    this.renumberRow = function (row, from, to) {
        ...
        $('input#invoice-invoices-items-' + from + '-invoice-id', row).prop('name', 'invoices_items[' + to + '][invoice_id]').prop('id', 'invoice-invoices-items-' + to + '-document-id');
    ...
    $('a#add-invoices-item-row', this).click($this.addRow);

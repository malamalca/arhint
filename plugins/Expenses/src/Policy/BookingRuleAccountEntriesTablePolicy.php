...
/**
 * BookingRuleAccountEntriesTable Policy Resolver
 */
class BookingRuleAccountEntriesTablePolicy
{
    /**
     * Index scope – account entries are visible to all authenticated plugin
     * users whose company owns the parent rule.
     *

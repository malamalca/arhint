...
class ExpensePolicy
{
     ...
     * @return bool
     */
    public function canView(User $user, Expense $entity): bool
    {
     ...
     * @return bool
     */
    public function canEdit(User $user, Expense $entity): bool
    {
        return $entity->owner_id == $user->company_id;
    }
     ...
     * @return bool
     */
    public function canDelete(User $user, Expense $entity): bool
    {
        return $entity->owner_id == $user->company_id;
    }
}

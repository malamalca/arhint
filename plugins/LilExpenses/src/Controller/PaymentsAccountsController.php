 ...
 *
 * @property \LilExpenses\Model\Table\PaymentsAccountsTable $PaymentsAccounts
 */
class PaymentsAccountsController extends AppController
{
    ...
    public function edit($id = null)
    {
        ...
        if ($this->getRequest()->is(['patch', 'post', 'put'])) {
            ...
            if ($this->PaymentsAccounts->save($account)) {
                $this->Flash->success(__d('lil_expenses', 'The payments account has been saved.'));

                return $this->redirect(['action' => 'index']);
            } else {
                $this->Flash->error(__d('lil_expenses', 'The payments account could not be saved. Please, try again.'));
            }
        }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->PaymentsAccounts->delete($paymentsAccount)) {
            $this->Flash->success(__d('lil_expenses', 'The payments account has been deleted.'));
        } else {
            $this->Flash->error(__d('lil_expenses', 'The payments account could not be deleted. Please, try again.'));
        }

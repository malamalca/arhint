...
$title = __d('lil_expenses', 'IMPORT: SepaXML - Step2 - {0}', [$linkUnfinished]);

$report = [
    'title_for_layout' => $title,
    'menu' => [
        'clear' => [
            'title' => __d('lil_expenses', 'Upload file'),
            'visible' => true,
            'url' => ['?' => ['clearcache' => 1]],
        ],
    ],
        ...
        'payments' => ['table' => [
            ...
            'head' => ['rows' => [['columns' => [
                ...
                'descript' => [
                    ...
                    'html' => __d('lil_expenses', 'Descript'),
                ],
                ...
                'net_total' => [
                    'parameters' => ['class' => 'left-align'],
                    'html' => __d('lil_expenses', 'Ref'),
                ],

                'action' => [
                    'parameters' => ['class' => 'left-align'],
                    'html' => __d('lil_expenses', 'Action'),
                ],
            ]]]],
            'body' => ['rows' => []],
            'foot' => ['rows' => [['columns' => [
...
echo $this->Lil->panels($report, 'LilExpenses.Expenses.import_sepa_step2');
?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#popupItem-PayExpense").modalPopup({
            title: "<?=__d('lil_expenses', 'Add Payment to Existing Expense');?>",
            processSubmit: true,
            onBeforeRequest: function() {
        ...
        $("#popupItem-AddExpense").modalPopup({
            title: "<?=__d('lil_expenses', 'Add new Expense');?>",
            processSubmit: true,
            onBeforeRequest: function() {

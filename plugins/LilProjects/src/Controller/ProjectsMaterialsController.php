 ...
 *
 * @property \LilProjects\Model\Table\ProjectsMaterialsTable $ProjectsMaterials
 * @method \LilProjects\Model\Entity\ProjectsMaterial[]|\Cake\Datasource\ResultSetInterface paginate($object = null, array $settings = [])
 */
class ProjectsMaterialsController extends AppController
{
    ...
    public function index()
    {
        ...
        $groups = Configure::read('LilProjects.materialGroups');
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            ...
            if ($this->ProjectsMaterials->save($projectsMaterial)) {
                $this->Flash->success(__d('lil_projects', 'The projects material has been saved.'));

                return $this->redirect(['action' => 'index']);
            }
            $this->Flash->error(__d('lil_projects', 'The projects material could not be saved. Please, try again.'));
        }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->ProjectsMaterials->delete($projectsMaterial)) {
            $this->Flash->success(__d('lil_projects', 'The projects material has been deleted.'));
        } else {
            $this->Flash->error(__d('lil_projects', 'The projects material could not be deleted. Please, try again.'));
        }

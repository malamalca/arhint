 ...
 *
 * @property \Projects\Model\Table\ProjectsCompMaterialsTable $ProjectsCompMaterials
...
class ProjectsCompMaterialsController extends AppController
{
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            ...
            if ($this->ProjectsCompMaterials->save($material)) {
                ...
                $this->Flash->success(__d('projects', 'The projects comp material has been saved.'));
            ...
            $this->Flash->error(__d('projects', 'The material could not be saved. Please, try again.'));
        }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->ProjectsCompMaterials->delete($material)) {
            ...
            $this->Flash->success(__d('projects', 'The material has been deleted.'));
        } else {
            $this->Flash->error(__d('projects', 'The material could not be deleted. Please, try again.'));
        }

...
$tableIndex = [
    'title_for_layout' => __d('projects', 'Materials'),
    'menu' => [
        'add' => [
        ...
        'head' => ['rows' => [
            [
                'columns' => [
                    'search' => [
                        ...
                        'html' => sprintf('<input placeholder="%s" id="SearchBox" />', __d('projects', 'Search')),
                    ],
                    'pagination' => [
            ...
            [
                'columns' => [
                    ...
                    'group' => __d('projects', 'Group'),
                    'thickness' => __d('projects', 'Thickness [cm]'),
                    'actions' => [],
                ],
            ],
        ]],
...
echo $this->Lil->index($tableIndex, 'Projects.ProjectsMaterials.index');
?>
